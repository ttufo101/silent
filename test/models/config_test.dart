...
void main() {
  ...
  group('AppSettingProps JSON round-trip', () {
    test('default values survive round-trip', () {
      ...
      expect(restored.themeMode.name, 'light');
    ...
    test('theme mode survives JSON round-trip', () {
      final restored = AppSettingProps.fromJson({'themeMode': 'dark'});
      expect(restored.themeMode.name, 'dark');
      expect(restored.toJson()['themeMode'], 'dark');
    });
  });
