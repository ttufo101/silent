...
enum GeoResource {
  ...
  static GeoResource? tryFromJson(String value) {
    return switch (value) {
  ...
  static GeoResource fromJson(String value) {
    final resource = tryFromJson(value);
    if (resource == null) {
      throw ArgumentError.value(value, 'value', 'Invalid geo resource');
    }
    return resource;
  }
}
...
enum ScrollPositionCacheKey { tools, proxiesList, proxiesTabList }

enum QueryTag { proxies, access }

enum LoadingTag { backup_restore, access, proxies, batteryOptimization }
