...
class AppLocalizations {
  ...
  String get connectNow {
    return Intl.message('Connect now', name: 'connectNow', desc: '', args: []);
  }
  ...
  String get personalCenter {
    return Intl.message('Profile', name: 'personalCenter', desc: '', args: []);
  }
  ...
  /// `Proxy and network`
  String get proxyAndNetwork {
    return Intl.message(
      'Proxy and network',
      name: 'proxyAndNetwork',
      desc: '',
      args: [],
    );
  }
  ...
  String get authEnterEmailDescription {
    return Intl.message(
      'Enter your registered email and we\'ll send you a verification code.',
      name: 'authEnterEmailDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String authCodeSent(Object email) {
    return Intl.message(
      'A verification code was sent to $email',
      name: 'authCodeSent',
      desc: '',
  ...
  String get authResend {
    return Intl.message('Resend', name: 'authResend', desc: '', args: []);
  }

  /// `Resend in {seconds}s`
  String authResendIn(Object seconds) {
    return Intl.message(
      'Resend in ${seconds}s',
      name: 'authResendIn',
      desc: '',
  ...
  String get authLoading {
    return Intl.message('Please wait', name: 'authLoading', desc: '', args: []);
  }

  /// `Unable to load proxy configuration`
  String get serverProfileLoadFailed {
    return Intl.message(
      'Unable to load proxy configuration',
      name: 'serverProfileLoadFailed',
      desc: '',
      args: [],
    );
  }
  ...
  String get serverProfileSyncFailed {
    return Intl.message(
      'Unable to update proxy configuration',
      name: 'serverProfileSyncFailed',
      desc: '',
      args: [],
    );
  }
