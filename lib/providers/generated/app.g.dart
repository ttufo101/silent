...
@ProviderFor(ServerProfileSyncError)
final serverProfileSyncErrorProvider = ServerProfileSyncErrorProvider._();

final class ServerProfileSyncErrorProvider
    extends $NotifierProvider<ServerProfileSyncError, String?> {
  ServerProfileSyncErrorProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'serverProfileSyncErrorProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$serverProfileSyncErrorHash();

  @$internal
  @override
  ServerProfileSyncError create() => ServerProfileSyncError();
...
String _$serverProfileSyncErrorHash() =>
    r'968f4ba0232a09f2bbdca07b258d24c453e7db84';

abstract class _$ServerProfileSyncError extends $Notifier<String?> {
  String? build();
  @$mustCallSuper
  @override
  WhenComplete runBuild() {
...
String _$currentPageLabelHash() => r'a6c00ef2855eac8dd4c15b9cacdfcab3e01ffdc5';
...
String _$networkDetectionHash() => r'bbf4678f147c6c9acc401afd487d917e0669266d';
